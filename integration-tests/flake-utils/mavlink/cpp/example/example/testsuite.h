/** @file
 *    @brief MAVLink comm protocol testsuite generated from example.xml
...
static void mavlink_test_example(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_example(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_example(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
